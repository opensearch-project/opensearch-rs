...
### Dependencies
- Bumps `sysinfo` from 0.31.2 to 0.34.1 ([#331](https://github.com/opensearch-project/opensearch-rs/pull/331))
...
- Bump `lycheeverse/lychee-action` from 1.5.0 to 2.4.0 ([#310](https://github.com/opensearch-project/opensearch-rs/pull/310), [#321](https://github.com/opensearch-project/opensearch-rs/pull/321), [#332](https://github.com/opensearch-project/opensearch-rs/pull/332))
