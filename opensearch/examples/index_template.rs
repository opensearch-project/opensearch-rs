...
use url::Url;
use opensearch::indices::{IndicesPutIndexTemplateParts, IndicesCreateParts, IndicesGetParts,IndicesGetIndexTemplateParts, IndicesDeleteIndexTemplateParts, IndicesDeleteParts};
use opensearch::cluster::{ClusterPutComponentTemplateParts, ClusterDeleteComponentTemplateParts};
use serde_json::json;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    client.indices().get_index_template(IndicesGetIndexTemplateParts::Name(&["books"])).send().await?;
