...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Bulk API](https://opensearch.org/)\n\nAllows to perform multiple index/update/delete operations in a single request."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Clear Scroll API](https://opensearch.org/)\n\nExplicitly clears the search context for a scroll."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Count API](https://opensearch.org/)\n\nReturns number of documents matching a query."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Create API](https://opensearch.org/)\n\nCreates a new document in the index.\n\nReturns a 409 response when a document with a same ID already exists in the index."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Delete API](https://opensearch.org/)\n\nRemoves a document from the index."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Delete By Query API](https://opensearch.org/)\n\nDeletes documents matching the provided query."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Delete By Query Rethrottle API](https://opensearch.org/)\n\nChanges the number of requests per second for a particular Delete By Query operation."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Delete Script API](https://opensearch.org/)\n\nDeletes a script."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Exists API](https://opensearch.org/)\n\nReturns information about whether a document exists in an index."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Exists Source API](https://opensearch.org/)\n\nReturns information about whether a document source exists in an index."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Explain API](https://opensearch.org/)\n\nReturns information about why a specific matches (or doesn't match) a query."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Field Caps API](https://opensearch.org/)\n\nReturns the information about the capabilities of fields among multiple indices."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Get API](https://opensearch.org/)\n\nReturns a document."]
pub struct Get<'a, 'b> {
    transport: &'a Transport,
    parts: GetParts<'b>,
    _source: Option<&'b [&'b str]>,
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Get Script API](https://opensearch.org/)\n\nReturns a script."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Get Source API](https://opensearch.org/)\n\nReturns the source of a document."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Index API](https://opensearch.org/)\n\nCreates or updates a document in an index."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Info API](https://opensearch.org/)\n\nReturns basic information about the cluster."]
pub struct Info<'a, 'b> {
    transport: &'a Transport,
    parts: InfoParts,
    error_trace: Option<bool>,
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Mget API](https://opensearch.org/)\n\nAllows to get multiple documents in one request."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Msearch API](https://opensearch.org/)\n\nAllows to execute several search operations in one request."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Msearch Template API](https://opensearch.org/)\n\nAllows to execute several search template operations in one request."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Mtermvectors API](https://opensearch.org/)\n\nReturns multiple termvectors in one request."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ping API](https://opensearch.org/)\n\nReturns whether the cluster is running."]
pub struct Ping<'a, 'b> {
    transport: &'a Transport,
    parts: PingParts,
    error_trace: Option<bool>,
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Put Script API](https://opensearch.org/)\n\nCreates or updates a script."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Reindex API](https://opensearch.org/)\n\nAllows to copy documents from one index to another, optionally filtering the source\ndocuments by a query, changing the destination index settings, or fetching the\ndocuments from a remote cluster."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Reindex Rethrottle API](https://opensearch.org/)\n\nChanges the number of requests per second for a particular Reindex operation."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Render Search Template API](https://opensearch.org/)\n\nAllows to use the Mustache language to pre-render a search definition."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Scroll API](https://opensearch.org/)\n\nAllows to retrieve a large numbers of results from a single search request."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Search API](https://opensearch.org/)\n\nReturns results matching a query."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Search Shards API](https://opensearch.org/)\n\nReturns information about the indices and shards that a search request would be executed against."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Search Template API](https://opensearch.org/)\n\nAllows to use the Mustache language to pre-render a search definition."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Termvectors API](https://opensearch.org/)\n\nReturns information and statistics about terms in the fields of a particular document."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Update API](https://opensearch.org/)\n\nUpdates a document with a script or partial document."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Update By Query Rethrottle API](https://opensearch.org/)\n\nChanges the number of requests per second for a particular Update By Query operation."]
...
impl Elasticsearch {
    ...
    #[doc = "[Delete By Query Rethrottle API](https://opensearch.org/)\n\nChanges the number of requests per second for a particular Delete By Query operation."]
    ...
    #[doc = "[Mtermvectors API](https://opensearch.org/)\n\nReturns multiple termvectors in one request."]
    ...
    #[doc = "[Render Search Template API](https://opensearch.org/)\n\nAllows to use the Mustache language to pre-render a search definition."]
    ...
    #[doc = "[Search Template API](https://opensearch.org/)\n\nAllows to use the Mustache language to pre-render a search definition."]
    ...
    #[doc = "[Update By Query Rethrottle API](https://opensearch.org/)\n\nChanges the number of requests per second for a particular Update By Query operation."]
